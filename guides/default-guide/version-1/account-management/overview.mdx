...
[Edit on GitHub](https://github.com/GitbookIO/public-docs/blob/main/account-management/overview.md)

Overview
========

Manage the team you collaborate with in GitBook.
...
**Billing & Account Management FAQ**
