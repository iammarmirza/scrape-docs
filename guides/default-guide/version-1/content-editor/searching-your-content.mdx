---
title: Searching content | GitBook Documentation
slug: searching-your-content
visibility: PUBLIC
label: Searching content | GitBook Documentation
---
...
[Edit on GitHub](https://github.com/GitbookIO/public-docs/blob/main/content-editor/searching-your-content/README.md)
...
**Permissions** For **published content**, anyone can use the built-in **Search** bar in the top-right of the screen to find the answers or pages they’re looking for.
